...
void COROSSParser::processComments() {
    std::wstring sm_komment(L"(\\s*_*[—|с]м_*\\._*\\s*коммент\\.\\s*к\\s*)([_\\-\\u00B9\\u00B2\\u00B3а-€ј-я®Є\\<sup\\>123\\</sup\\>]+[-]*[Е]*([\\.]{3})*\\s*)([_\\u00B9\\u00B2\\u00B3а-€ј-я®Є\\<sup\\>123\\</sup\\>]*)");//
    std::wstring smotri(L"(\\s*_*[—|с]м_*\\._*\\s*)([_\\-\\u00B9\\u00B2\\u00B3а-€ј-я®Є\\<sup\\>123\\</sup\\>]+[-]*[Е]*([\\.]{3})*\\s*)([_\\u00B9\\u00B2\\u00B3а-€ј-я®Є\\<sup\\>123\\</sup\\>]*)");//L"\\s[—|с]м\\.\\s*");
...
void COROSSParser::makeABCTable(const std::locale& loc)
{
    ...
    abcMap.insert(std::pair<wchar_t, std::wstring>(L'Є', L"yo"));
    ...
    abcMap.insert(std::pair<wchar_t, std::wstring>(L'€', L"ya"));
