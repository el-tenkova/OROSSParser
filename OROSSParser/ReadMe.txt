========================================================================
    ACTIVE TEMPLATE LIBRARY : OROSSParser Project Overview
========================================================================

AppWizard has created this OROSSParser project for you to use as the starting point for
...
OROSSParser.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (OROSSParser.h)
        GUID definitions                                (OROSSParser_i.c)
        A type library                                  (OROSSParser.tlb)
        Marshaling code                                 (OROSSParser_p.c and dlldata.c)

OROSSParser.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in OROSSParser.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named OROSSParser.pch and a precompiled types file named StdAfx.obj.
...
OROSSParserps.vcxproj
	...
	dlldata.c, OROSSParser_i.c and OROSSParser_p.c which are required
	to build the proxy/stub DLL.

OROSSParserps.vcxproj.filters
